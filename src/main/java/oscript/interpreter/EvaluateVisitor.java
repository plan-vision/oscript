...
public class EvaluateVisitor implements ObjectVisitor, OscriptParserConstants
{
  ...
  {
    Value val = returnHelper( (Value)(n.f1.accept(this,argu)) );
    
    throw PackagedScriptObjectException.makeExceptionWrapper2(val);
  }
  ...
  public Object visit( ImportBlock n, Object argu )
  {
    ...
    return OscriptInterpreter.importHelper( val.castToString(), thisScope );
  }
  ...
  public Object visit( ReturnStatement n, Object argu )
  {
    ...
    if( n.f1.present() )
      retVal = returnHelper( (Value)(n.f1.node.accept( this, argu )) );
    ...
    if( n.f0.present() )
    {
      ...
      switch(NodeToken_kind)
      {
        ...
        case BANG:
          ...
          break;
        default:
          throw new ProgrammingErrorException("bad unary op: " + NodeToken_kind);
      }
    }
