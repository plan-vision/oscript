 ...
 * @version 1
 */
public class OUnsupportedOperationException extends OException
{
  /**
   ...
   */
  public OUnsupportedOperationException( String str )
  {
    super( TYPE, str );
  }
   ...
   */
  public OUnsupportedOperationException( oscript.util.MemberTable args )
  {
    this( getArg0(args) );
  }
}
