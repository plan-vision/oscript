...
/**
 * The <code>ForkScope</code> is used to implement a fork in the scope chain.
 * This is needed because when evaluating a superFxn, or a method defined in the
 * superFxn, the scope chain should use the scope that the superFxn is defined
 * in, rather than the scope of the derived function.
 * <p>
 * This is basically just a simple wrapper for the <code>obj</code>, with the
 * exception that lookupInScope uses <code>env</code> as the previous instead.
 * This means that any member created in this scope is actually created in the
 * <code>obj</code> scope.
 * 
...
public class ForkScope extends Scope {
    ...
    /* ======================================================================= */
    /**
     * In case a scope has any resource allocated from a source which will no long
     * be valid after a stack frame has returned (ie. resource allocated from
     * stack), return a copy of the scope that is safe to keep after the stack frame
     * returns.
     */
    ...
    /* ======================================================================= */
    /**
     * Get a member from this scope. This is used to access local variables and
     * object attributes from methods of the object. If the attribute isn't in this
     * node in the scope chain, then the <code>previous</code> node in the scope
     * chain is checked.
     * 
     * @param id the id of the symbol that maps to the member
     * @throws PackagedScriptObjectException(NoSuchMemberException)
