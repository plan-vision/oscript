 ...
 * @version 1
 */
public class ONullReferenceException extends OException
{
  /**
   ...
   */
  public ONullReferenceException( String str )
  {
    super( TYPE, str );
  }
   ...
   */
  public ONullReferenceException( oscript.util.MemberTable args )
  {
    this( getArg0(args) );
  }
}
