...
//  }
  ...
  /*=======================================================================*/
  /**
   * A helper function for evaluating an <i>ReturnStatement</i> or 
   * <i>ThrowBlock</i>, to ensure that the value being returned/thrown 
   * is not <code>(undefined)</code>.
   */
  public static final Value returnHelper( Value val )
  {
    // XXX work around bug that results in null on the stack...
    if( val == null )
      val = Value.NULL;
    ...
    {
      if( !"warning".equals( System.getProperty("oscript.undefined.return") ) )
      ...
      //////////////////////////////////////////////////////////////////////////
      OscriptHost.me.warn("warning: cannot return or throw (undefined)" + desc);
    }
