...
public class OscriptParser implements OscriptParserConstants {
    ...
    static final public VariableDeclaration VariableDeclaration(boolean canHaveVarAssignmentExpr)
    ...
    static final public FunctionDeclaration FunctionDeclaration() throws ParseException {
        ...
        return new FunctionDeclaration(n0, n1, n3, n5, n7, n9, n11, n17, n19, n20,
                hadVarInScope || hadForceScopeCreation, hadFxnInScope);
        // throw new Error("Missing return statement in function");
    }
    ...
    static final public PrimaryExpressionWithTrailingFxnCallExpList PrimaryExpressionWithTrailingFxnCallExpList()
            throws ParseException {
        PrimaryPrefix n0;
        NodeListOptional n1 = new NodeListOptional();
    ...
    static final public FunctionPrimaryPrefix FunctionPrimaryPrefix() throws ParseException {
        ...
        n17 = JTBToolkit.makeNodeToken(n18);
        return new FunctionPrimaryPrefix(n0, n2, n4, n6, n8, n14, n16, n17, hadVarInScope || hadForceScopeCreation,
                hadFxnInScope);
        // throw new Error("Missing return statement in function");
    }
    ...
    static final public PrimaryPostfixWithTrailingFxnCallExpList PrimaryPostfixWithTrailingFxnCallExpList()
            throws ParseException {
        NodeChoice n0;
    ...
    static final private boolean jj_3R_142() {
        if (jj_scan_token(REGEXP_LITERAL))
            return true;
        if (jj_la == 0 && jj_scanpos == jj_lastpos)
            return false;
        return false;
    ...
    static final private int[] jj_la1_0 = { 0x20000, 0xb0d80000, 0x0, 0x0, 0x30980000, 0x0, 0x400000, 0x8000000, 0x0,
            0x2000000, 0x40000000, 0x20500000, 0x20100000, 0x20100000, 0x20500000, 0x4000000, 0x20100000, 0x0,
            0x20100000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
            0x0, 0x0, 0x0, 0x0, 0x0, 0x20100000, 0x0, 0x0, 0x0, 0x20100000, 0x20100000, 0x400000, 0x8000000, 0x20100000,
            0x0, 0x0, 0x0, 0x0, 0x0, 0x20000000, 0x400000, 0x400000, };
    static final private int[] jj_la1_1 = { 0x0, 0xa86ffffb, 0x0, 0x20000, 0xa865f47b, 0x0, 0xb80, 0x0, 0x0, 0x0, 0x0,
            0xa84d5be1, 0xa8455061, 0xa8455061, 0xa84d5be1, 0x0, 0xa8455061, 0x0, 0xa8455061, 0x0, 0x0, 0x0, 0x0, 0x0,
            0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4, 0x4, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x20, 0xa8455041,
            0x0, 0x0, 0x0, 0xa8455041, 0xa8455040, 0xb80, 0x0, 0xa8455061, 0x0, 0x0, 0x0, 0x0, 0x0, 0xa8450040, 0xb80,
            0xb80, };
    static final private int[] jj_la1_2 = { 0x0, 0xe0180b48, 0x200, 0x0, 0xe0180948, 0x10000, 0x8, 0x0, 0x4000, 0x0,
            0x0, 0xe0180948, 0xe0180948, 0xe0180948, 0xe0180948, 0x0, 0xe0180948, 0x4000, 0xe0180948, 0x4000, 0x10000,
            0x10000, 0x200000, 0x8000000, 0x10000000, 0x0, 0x0, 0x0, 0x4800000, 0x4800000, 0x3060000, 0x3060000, 0x0,
            0x0, 0x80000000, 0x80000000, 0x0, 0x0, 0xe0180000, 0xe0180000, 0x60000000, 0x60000000, 0x0, 0x948, 0x8840,
            0x8840, 0x8800, 0x948, 0x848, 0x8, 0x0, 0xe0180948, 0x840, 0x8000, 0x800, 0x8000, 0x0, 0x0, 0x0, 0x0, };
    static final private int[] jj_la1_3 = { 0x0, 0x1, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x1, 0x1, 0x1,
            0x0, 0x1, 0x0, 0x1, 0x0, 0x1ffc00, 0x1ffc00, 0x0, 0x0, 0x0, 0x10, 0x20, 0x8, 0x0, 0x0, 0x0, 0x0, 0x380,
            0x380, 0x1, 0x1, 0x46, 0x46, 0x1, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0,
            0x0, 0x0, 0x200000, 0x0, 0x0, 0x0, };
    ...
    static public void ReInit(java.io.InputStream stream) {
        ...
        ASCII_UCodeESC_CharStream._lines = null;
    ...
    static final private Token jj_consume_token(int kind) throws ParseException {
        ...
        if ((oldToken = token).next != null)
            ...
            token = token.next = OscriptParserTokenManager.getNextToken();
        jj_ntk = -1;
        if (token.kind == kind) {
            jj_gen++;
            if (++jj_gc > 100) {
    ...
    static final public Token getToken(int index) {
        ...
        for (int i = 0; i < index; i++) {
            if (t.next != null)
                ...
                t = t.next = OscriptParserTokenManager.getNextToken();
        }
        return t;
    }
