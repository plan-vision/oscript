...
public class OscriptParserTokenManager implements OscriptParserConstants {
    ...
    static private final int jjStartNfaWithStates_0(int pos, int kind, int state) {
        jjmatchedKind = kind;
        jjmatchedPos = pos;
        int t = ASCII_UCodeESC_CharStream.readChar();
        if (t == -1)
            return pos + 1;
        curChar = (char) t;
    ...
    static final long[] jjtoToken = { 0xa87ffffffffa0001L, 0x3fffffffffffc8L, };
    static final long[] jjtoSkip = { 0x17c3eL, 0x0L, };
    static final long[] jjtoSpecial = { 0x17c00L, 0x0L, };
    static final long[] jjtoMore = { 0x483c0L, 0x0L, };
    ...
    public static final Token getNextToken() {
        ...
        EOFLoop: for (;;) {
            int t = ASCII_UCodeESC_CharStream.BeginToken();
            if (t == -1) {
                jjmatchedKind = 0;
            ...
            for (;;) {
                ...
                case 0:
                    ...
                    while (curChar <= 32 && (0x100003600L & (1L << curChar)) != 0L) {
                        int xt = ASCII_UCodeESC_CharStream.readChar();
                        if (xt == -1) {
                            continue EOFLoop;
                        }
                        curChar=(char)xt;
                ...
                int tx = ASCII_UCodeESC_CharStream.readChar();
                if(tx == -1) {
                    EOFSeen = true;
